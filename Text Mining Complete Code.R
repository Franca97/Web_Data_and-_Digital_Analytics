...
#'  
tweets <- userTimeline("@bbchealth", n=3200, includeRts=F) # userTimline to get the n first tweets 
...
jpeg("BBC Health per Day.jpg", width = 1500)
...
#' 
tweetsCorpus <- Corpus(VectorSource(BBC$text))
tweetsCorpus
...
jpeg("BBC Health General Wordcloud.jpg", width = 1500)
...
jpeg("BBC Health Topics.jpg", width = 1500)
topTerms %>%
...
country_df <- rbind(Maitlis, Johnson, BBC)
UK <- country_df
